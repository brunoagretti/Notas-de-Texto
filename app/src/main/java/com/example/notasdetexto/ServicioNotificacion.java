...
public class ServicioNotificacion extends IntentService {
    ...
    protected void onHandleIntent(Intent intent2) {
        ...
        Intent mIntent = new Intent(this, CrearRecordatorioActivity.class); //No se si esta es la activity correcta
        Resources res = this.getResources();
        Uri soundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_ALARM);

        String message = getString(R.string.new_notification) + " " + intent2.getExtras().getString("TEXTO");
